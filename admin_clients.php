            ...
            <div class="container-fluid container-order-area pt-4 px-4">
                <div class="text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h3 class="mb-0"><span class="fa fa-paste"></span>List of Clients </h3>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-hover mb-0">
                            ...
                            <tbody>
							 <?php
									include 'connect.php';
									$Get_query = "select A.*,B.* from client as A JOIN user_account as B on A.client_id = B.client_id where B.usertype <> 'administrator' ";						
										...
										while($row = $result->fetch(PDO::FETCH_ASSOC)){
											...
											?>
											 <tr class="text-dark">
												...
												<td><?php echo $row["subdivision"]?>/<?php echo $row["barangay"]?>/<?php echo $row["city"]?>/<?php echo $row["province"]?></td>
