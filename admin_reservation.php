        ...
        <div class="sidebar bg-light pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
					...
					<a href="admin_reservation.php" class="nav-link nav-link active"><i class="fa fa-calendar me-2"></i>Reservations</a>
            ...
            <div class="container-fluid container-order-area pt-4 px-4">
                <div class="text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h3 class="mb-0"><span class="fa fa-paste"></span>Table Reservation </h3>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-hover mb-0">
                            ...
                            <tbody>
							 <?php
									include 'connect.php';
									$Get_query = "select * from reservation ";						
